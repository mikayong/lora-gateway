...
{
    uint8_t i;
    GpioWrite( &SX1276.Gpio.Nss, 0 );
    lg08_sx127x_reg_wb( SX1276.spidev, addr, buffer, szie );
    GpioWrite( &SX1276.Gpio.Nss, 1 );
}
...
void SX1276ReadBuffer( uint16_t addr, uint8_t *buffer, uint8_t size )
{
    ...
    lg08_sx127x_reg_rb( SX1276.spidev, addr, buffer, szie );
